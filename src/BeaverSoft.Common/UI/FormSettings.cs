...
namespace BeaverSoft.Common.UI
{
    ...
    public static class FormsSettingsManager
    {
        ...
        private static readonly string ctWriteMtxName = System.Reflection.Assembly.GetEntryAssembly().GetName().Name + "_settingslock_mutex";
